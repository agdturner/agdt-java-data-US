...
public class US_Wave10_hhresp_Record extends US_hhresp_Record {
...
protected double XHWTSW1;
protected double XHWTSW2;
...
protected final void initHSIVW9(String s) {
if (!s.trim().isEmpty()) {
HSIVW9 = Byte.parseByte(s);
} else {
HSIVW9 = Byte.MIN_VALUE;
}
}
...
protected final void initXHWTSW1(String s) {
if (!s.trim().isEmpty()) {
XHWTSW1 = Double.parseDouble(s);
} else {
XHWTSW1 = Double.NaN;
}
}

protected final void initXHWTSW2(String s) {
if (!s.trim().isEmpty()) {
XHWTSW2 = Double.parseDouble(s);
} else {
XHWTSW2 = Double.NaN;
}
}
...
public US_Wave10_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
