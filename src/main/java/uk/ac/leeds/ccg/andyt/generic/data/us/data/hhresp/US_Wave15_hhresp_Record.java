...
public class US_Wave15_hhresp_Record extends US_hhresp_Record {
...
public US_Wave15_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
...
initIVH2_BH(s[156]);
initIVH3_BH(s[157]);
initHIENDDATHH(s[158]);
initHIENDDATMM(s[159]);
initIVFHO_BH(s[160]);
initHHORIG_BH(s[161]);
initHHDC(s[162]);
initXHWGHT(s[163]);
...
initNA75PL(s[175]);
initAGECHY_DV(s[176]);
initNCOUPLE_DV(s[177]);
initNONEPAR_DV(s[178]);
initNEMP_DV(s[179]);
initNWAGE_DV(s[180]);
initTENURE_DV(s[181]);
initXPHSN(s[182]);
