...
public class US_Wave17_hhresp_Record extends US_hhresp_Record {
...
public US_Wave17_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
...
initNA75PL(s[183]);
initAGECHY_DV(s[184]);
initNCOUPLE_DV(s[185]);
initNONEPAR_DV(s[186]);
initNEMP_DV(s[187]);
initNWAGE_DV(s[188]);
initTENURE_DV(s[189]);
initXPHSN(s[190]);
