...
public class US_Wave9_hhresp_Record extends US_hhresp_Record {
...
protected final void initHSIVW8(String s) {
if (!s.trim().isEmpty()) {
HSIVW8 = Byte.parseByte(s);
} else {
HSIVW8 = Byte.MIN_VALUE;
}
}
...
public US_Wave9_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
...
initIVH2_BH(s[144]);
initIVH3_BH(s[145]);
initHIENDDATHH(s[146]);
initHIENDDATMM(s[147]);
initIVFHO_BH(s[148]);
initHHORIG_BH(s[149]);
initHHDC(s[150]);
initXHWGHT(s[151]);
...
initNA75PL(s[163]);
initAGECHY_DV(s[164]);
initNCOUPLE_DV(s[165]);
initNONEPAR_DV(s[166]);
initNEMP_DV(s[167]);
initNWAGE_DV(s[168]);
initTENURE_DV(s[169]);
initXPHSN(s[170]);
