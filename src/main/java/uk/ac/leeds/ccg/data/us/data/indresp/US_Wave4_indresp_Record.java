...
public class US_Wave4_indresp_Record extends US_indresp_Record {
...
protected byte PYASM1;
protected byte PYASM2;
protected byte PYASM3;
protected byte PYBUNK;
protected byte PYDRUG;
protected byte PYENRL_BH;
protected byte PYESM1;
protected byte PYESM2;
protected byte PYESM3;
...
protected byte PYLIE;
protected short PYNYP;
protected short PYPNO1;
protected short PYPNO2;
protected short PYPNO3;
protected byte PYRULE;
protected short PYSAD1;
protected short PYSAD2;
protected short PYSAD3;
protected byte PYSER;
protected byte PYSMOK;
protected byte PYSTM;
protected byte PYSWR;
protected byte PYTDR1;
protected byte PYTDR2;
protected byte PYTDR3;
protected byte PYTHH1;
protected byte PYTHH2;
protected byte PYTHH3;
protected short PYTLK1;
protected short PYTLK2;
protected short PYTLK3;
protected byte PYTVRL;
...
protected final void initIVIOW3(String s) {
if (!s.trim().isEmpty()) {
IVIOW3 = Byte.parseByte(s);
} else {
IVIOW3 = Byte.MIN_VALUE;
}
}
...
protected final void initPYASM1(String s) {
if (!s.trim().isEmpty()) {
PYASM1 = Byte.parseByte(s);
} else {
PYASM1 = Byte.MIN_VALUE;
}
}

protected final void initPYASM2(String s) {
if (!s.trim().isEmpty()) {
PYASM2 = Byte.parseByte(s);
} else {
PYASM2 = Byte.MIN_VALUE;
}
}

protected final void initPYASM3(String s) {
if (!s.trim().isEmpty()) {
PYASM3 = Byte.parseByte(s);
} else {
PYASM3 = Byte.MIN_VALUE;
}
}

protected final void initPYBUNK(String s) {
if (!s.trim().isEmpty()) {
PYBUNK = Byte.parseByte(s);
} else {
PYBUNK = Byte.MIN_VALUE;
}
}

protected final void initPYDRUG(String s) {
if (!s.trim().isEmpty()) {
PYDRUG = Byte.parseByte(s);
} else {
PYDRUG = Byte.MIN_VALUE;
}
}

protected final void initPYENRL_BH(String s) {
if (!s.trim().isEmpty()) {
PYENRL_BH = Byte.parseByte(s);
} else {
PYENRL_BH = Byte.MIN_VALUE;
}
}

protected final void initPYESM1(String s) {
if (!s.trim().isEmpty()) {
PYESM1 = Byte.parseByte(s);
} else {
PYESM1 = Byte.MIN_VALUE;
}
}

protected final void initPYESM2(String s) {
if (!s.trim().isEmpty()) {
PYESM2 = Byte.parseByte(s);
} else {
PYESM2 = Byte.MIN_VALUE;
}
}

protected final void initPYESM3(String s) {
if (!s.trim().isEmpty()) {
PYESM3 = Byte.parseByte(s);
} else {
PYESM3 = Byte.MIN_VALUE;
}
}
...
protected final void initPYLIE(String s) {
if (!s.trim().isEmpty()) {
PYLIE = Byte.parseByte(s);
} else {
PYLIE = Byte.MIN_VALUE;
}
}
...
protected final void initPYRULE(String s) {
if (!s.trim().isEmpty()) {
PYRULE = Byte.parseByte(s);
} else {
PYRULE = Byte.MIN_VALUE;
}
}
...
protected final void initPYSER(String s) {
if (!s.trim().isEmpty()) {
PYSER = Byte.parseByte(s);
} else {
PYSER = Byte.MIN_VALUE;
}
}

protected final void initPYSMOK(String s) {
if (!s.trim().isEmpty()) {
PYSMOK = Byte.parseByte(s);
} else {
PYSMOK = Byte.MIN_VALUE;
}
}

protected final void initPYSTM(String s) {
if (!s.trim().isEmpty()) {
PYSTM = Byte.parseByte(s);
} else {
PYSTM = Byte.MIN_VALUE;
}
}

protected final void initPYSWR(String s) {
if (!s.trim().isEmpty()) {
PYSWR = Byte.parseByte(s);
} else {
PYSWR = Byte.MIN_VALUE;
}
}

protected final void initPYTDR1(String s) {
if (!s.trim().isEmpty()) {
PYTDR1 = Byte.parseByte(s);
} else {
PYTDR1 = Byte.MIN_VALUE;
}
}

protected final void initPYTDR2(String s) {
if (!s.trim().isEmpty()) {
PYTDR2 = Byte.parseByte(s);
} else {
PYTDR2 = Byte.MIN_VALUE;
}
}

protected final void initPYTDR3(String s) {
if (!s.trim().isEmpty()) {
PYTDR3 = Byte.parseByte(s);
} else {
PYTDR3 = Byte.MIN_VALUE;
}
}

protected final void initPYTHH1(String s) {
if (!s.trim().isEmpty()) {
PYTHH1 = Byte.parseByte(s);
} else {
PYTHH1 = Byte.MIN_VALUE;
}
}

protected final void initPYTHH2(String s) {
if (!s.trim().isEmpty()) {
PYTHH2 = Byte.parseByte(s);
} else {
PYTHH2 = Byte.MIN_VALUE;
}
}

protected final void initPYTHH3(String s) {
if (!s.trim().isEmpty()) {
PYTHH3 = Byte.parseByte(s);
} else {
PYTHH3 = Byte.MIN_VALUE;
}
}
...
protected final void initPYTVRL(String s) {
if (!s.trim().isEmpty()) {
PYTVRL = Byte.parseByte(s);
} else {
PYTVRL = Byte.MIN_VALUE;
}
}
...
public byte getPYASM1() {
return PYASM1;
}

public byte getPYASM2() {
return PYASM2;
}

public byte getPYASM3() {
return PYASM3;
}

public byte getPYBUNK() {
return PYBUNK;
}

public byte getPYDRUG() {
return PYDRUG;
}

public byte getPYENRL_BH() {
return PYENRL_BH;
}

public byte getPYESM1() {
return PYESM1;
}

public byte getPYESM2() {
return PYESM2;
}

public byte getPYESM3() {
return PYESM3;
}
...
public byte getPYSER() {
return PYSER;
}

public byte getPYSMOK() {
return PYSMOK;
}

public byte getPYSTM() {
return PYSTM;
}

public byte getPYSWR() {
return PYSWR;
}

public byte getPYTDR1() {
return PYTDR1;
}

public byte getPYTDR2() {
return PYTDR2;
}

public byte getPYTDR3() {
return PYTDR3;
}

public byte getPYTHH1() {
return PYTHH1;
}

public byte getPYTHH2() {
return PYTHH2;
}

public byte getPYTHH3() {
return PYTHH3;
}
...
public US_Wave4_indresp_Record(String line) {
s = line.split("\t");
initPID(s[0]);
initHIQUALB_DV(s[1]);
initHID(s[2]);
...
initFIMNI(s[809]);
initFIMNT(s[810]);
initFIMNLABGRS_DV(s[811]);
initFIMNNL(s[812]);
initFIMNGRS_DV(s[813]);
initFIYRL(s[814]);
initFIYRNL(s[815]);
initFIYRP(s[816]);
initFIYRB(s[817]);
...
initFIHHMNI(s[860]);
initIMPEVENT1(s[861]);
initIMPEVENT1S(s[862]);
initIMPEVENT2(s[863]);
initIMPEVENT2S(s[864]);
initIMPEVENT3(s[865]);
initIMPEVENT3S(s[866]);
initIMPEVENT4(s[867]);
initIMPEVENT4S(s[868]);
initMRJEND(s[869]);
initMRJSOC(s[870]);
initMRJSIC(s[871]);
initMRJSEMP(s[872]);
...
initISCED(s[905]);
initCASMIN(s[906]);
initMRJISCO88_CC(s[907]);
initJBISCO_CC(s[908]);
initJLISCO_CC(s[909]);
initMRJISCO_CC(s[910]);
initPLBORNC_CC(s[911]);
initJ2PAY_BH(s[912]);
initJLNSSEC_DV(s[913]);
initMRJNSSEC_DV(s[914]);
initJBNSSEC_DV(s[915]);
initJBNSSEC8_DV(s[916]);
initJLNSSEC8_DV(s[917]);
initMRJNSSEC8_DV(s[918]);
initNETPH_1(s[919]);
initNETSX_1(s[920]);
initNETWR_1(s[921]);
initNETRL_1(s[922]);
...
initJSPL(s[952]);
initAIDHRS(s[953]);
initJBSOC90_CC(s[954]);
initJLSOC90_CC(s[955]);
initJ2SOC90_CC(s[956]);
initJUSOC90_CC(s[957]);
initJBSOC90LY_CC(s[958]);
initSPSOC90_CC(s[959]);
initJBISCO88_CC(s[960]);
initJLISCO88_CC(s[961]);
initMEMORIG_BH(s[962]);
initMEMORIG(s[963]);
initHHORIG(s[964]);
initWKTIME(s[965]);
initHIQUAL_DV(s[966]);
