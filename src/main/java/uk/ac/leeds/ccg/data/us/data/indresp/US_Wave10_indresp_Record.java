...
public class US_Wave10_indresp_Record extends US_indresp_Record {
protected byte ADLA;
...
protected byte LNGCNV;
protected byte LNGENG;
protected byte LNGOTH;
protected byte LNGRED;
protected byte LNGUSA;
protected byte LNGUSB;
protected byte LNGUSN;
protected byte LNGWKE;
protected byte LNGWKO;
protected byte LNGWKX;
...
protected final void initLNGCNV(String s) {
if (!s.trim().isEmpty()) {
LNGCNV = Byte.parseByte(s);
} else {
LNGCNV = Byte.MIN_VALUE;
}
}

protected final void initLNGENG(String s) {
if (!s.trim().isEmpty()) {
LNGENG = Byte.parseByte(s);
} else {
LNGENG = Byte.MIN_VALUE;
}
}

protected final void initLNGOTH(String s) {
if (!s.trim().isEmpty()) {
LNGOTH = Byte.parseByte(s);
} else {
LNGOTH = Byte.MIN_VALUE;
}
}

protected final void initLNGRED(String s) {
if (!s.trim().isEmpty()) {
LNGRED = Byte.parseByte(s);
} else {
LNGRED = Byte.MIN_VALUE;
}
}

protected final void initLNGUSA(String s) {
if (!s.trim().isEmpty()) {
LNGUSA = Byte.parseByte(s);
} else {
LNGUSA = Byte.MIN_VALUE;
}
}

protected final void initLNGUSB(String s) {
if (!s.trim().isEmpty()) {
LNGUSB = Byte.parseByte(s);
} else {
LNGUSB = Byte.MIN_VALUE;
}
}

protected final void initLNGUSN(String s) {
if (!s.trim().isEmpty()) {
LNGUSN = Byte.parseByte(s);
} else {
LNGUSN = Byte.MIN_VALUE;
}
}

protected final void initLNGWKE(String s) {
if (!s.trim().isEmpty()) {
LNGWKE = Byte.parseByte(s);
} else {
LNGWKE = Byte.MIN_VALUE;
}
}

protected final void initLNGWKO(String s) {
if (!s.trim().isEmpty()) {
LNGWKO = Byte.parseByte(s);
} else {
LNGWKO = Byte.MIN_VALUE;
}
}

protected final void initLNGWKX(String s) {
if (!s.trim().isEmpty()) {
LNGWKX = Byte.parseByte(s);
} else {
LNGWKX = Byte.MIN_VALUE;
}
}
...
protected final void initSVAC(String s) {
if (!s.trim().isEmpty()) {
SVAC = Byte.parseByte(s);
} else {
SVAC = Byte.MIN_VALUE;
}
}
...
public byte getLNGCNV() {
return LNGCNV;
}

public byte getLNGENG() {
return LNGENG;
}

public byte getLNGOTH() {
return LNGOTH;
}

public byte getLNGRED() {
return LNGRED;
}

public byte getLNGUSA() {
return LNGUSA;
}

public byte getLNGUSB() {
return LNGUSB;
}

public byte getLNGUSN() {
return LNGUSN;
}

public byte getLNGWKE() {
return LNGWKE;
}

public byte getLNGWKO() {
return LNGWKO;
}

public byte getLNGWKX() {
return LNGWKX;
}
...
public US_Wave10_indresp_Record(String line) {
s = line.split("\t");
initPID(s[0]);
initHIQUALB_DV(s[1]);
initHID(s[2]);
...
initBUTYPE(s[1002]);
initBUNO(s[1003]);
initNCHILD_DV(s[1004]);
initHOH(s[1005]);
initRACH16_DV(s[1006]);
initSAMPST_BH(s[1007]);
initMOVEST(s[1008]);
initQFX(s[1009]);
initQFXC(s[1010]);
initQFXD(s[1011]);
...
initFIMNI(s[1092]);
initFIMNT(s[1093]);
initFIMNLABGRS_DV(s[1094]);
initFIMNNL(s[1095]);
initFIMNGRS_DV(s[1096]);
initFIYRL(s[1097]);
initFIYRNL(s[1098]);
initFIYRP(s[1099]);
initFIYRB(s[1100]);
...
initFIYR(s[1103]);
initFIHHMN(s[1104]);
initSCGHQ1_DV(s[1105]);
initSCGHQ2_DV(s[1106]);
initSPJB(s[1107]);
initSPJBHR(s[1108]);
initSPJBOT(s[1109]);
initSPPAYG(s[1110]);
...
initISCED(s[1195]);
initCASMIN(s[1196]);
initMRJISCO88_CC(s[1197]);
initJBISCO_CC(s[1198]);
initJLISCO_CC(s[1199]);
initJ1ISCO_CC(s[1200]);
initMAISCO_CC(s[1201]);
initPAISCO_CC(s[1202]);
initMRJISCO_CC(s[1203]);
initPLBORNC_CC(s[1204]);
initJ2PAY_BH(s[1205]);
initJLNSSEC_DV(s[1206]);
initMANSSEC_DV(s[1207]);
initPANSSEC_DV(s[1208]);
initMRJNSSEC_DV(s[1209]);
initJ1NSSEC_DV(s[1210]);
initJBNSSEC_DV(s[1211]);
initJBNSSEC8_DV(s[1212]);
initJLNSSEC8_DV(s[1213]);
initMANSSEC8_DV(s[1214]);
initPANSSEC8_DV(s[1215]);
initMRJNSSEC8_DV(s[1216]);
initJ1NSSEC8_DV(s[1217]);
initNETPH_1(s[1218]);
initNETSX_1(s[1219]);
initNETWR_1(s[1220]);
initNETRL_1(s[1221]);
...
initMAJU(s[1249]);
initPAJU(s[1250]);
initEXTRATE_BH(s[1251]);
initEXTNSA(s[1252]);
initBASRATE_BH(s[1253]);
initBASREST_BH(s[1254]);
initBASNSA(s[1255]);
initOVTRATE_BH(s[1256]);
initOVTNSA(s[1257]);
initJSTTWT(s[1258]);
initREMAIL_CODE(s[1259]);
initMLSTAT(s[1260]);
initJBSECT(s[1261]);
initJSPAYW(s[1262]);
initPLBORNC(s[1263]);
...
initJSPL(s[1274]);
initAIDHRS(s[1275]);
initMASOC90_CC(s[1276]);
initPASOC90_CC(s[1277]);
initJBSOC90_CC(s[1278]);
initJLSOC90_CC(s[1279]);
initJ1SOC90_CC(s[1280]);
initJ2SOC90_CC(s[1281]);
initJUSOC90_CC(s[1282]);
initJBSOC90LY_CC(s[1283]);
initSPSOC90_CC(s[1284]);
initJBISCO88_CC(s[1285]);
initJLISCO88_CC(s[1286]);
initJ1ISCO88_CC(s[1287]);
initMAISCO88_CC(s[1288]);
initPAISCO88_CC(s[1289]);
initUKCITZN_DV_BH(s[1290]);
initWKTIME(s[1291]);
initHIQUAL_DV(s[1292]);
}
}
