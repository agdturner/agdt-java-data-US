...
public class US_Wave4_hhresp_Record extends US_hhresp_Record {
...
protected final void initHSIVW3(String s) {
if (!s.trim().isEmpty()) {
HSIVW3 = Byte.parseByte(s);
} else {
HSIVW3 = Byte.MIN_VALUE;
}
}
...
public US_Wave4_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
