...
public class US_Wave11_hhresp_Record extends US_hhresp_Record {
...
public US_Wave11_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
...
initIVH2_BH(s[150]);
initIVH3_BH(s[151]);
initHIENDDATHH(s[152]);
initHIENDDATMM(s[153]);
initIVFHO_BH(s[154]);
initHHORIG_BH(s[155]);
initHHDC(s[156]);
initXHWGHT(s[157]);
...
initNA75PL(s[169]);
initAGECHY_DV(s[170]);
initNCOUPLE_DV(s[171]);
initNONEPAR_DV(s[172]);
initNEMP_DV(s[173]);
initNWAGE_DV(s[174]);
initTENURE_DV(s[175]);
initXPHSN(s[176]);
