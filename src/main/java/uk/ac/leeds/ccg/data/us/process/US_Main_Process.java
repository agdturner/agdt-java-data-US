 ...
 */
package uk.ac.leeds.ccg.data.us.process;
...
import uk.ac.leeds.ccg.data.us.core.US_Environment;
import uk.ac.leeds.ccg.data.us.io.US_Files;
import uk.ac.leeds.ccg.data.us.core.US_Object;
import uk.ac.leeds.ccg.data.us.data.US_Data;
import uk.ac.leeds.ccg.data.us.data.US_ID;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave1_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave2_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave3_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave4_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave5_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave6_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave7_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave8_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave9_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave10_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave11_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave12_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave13_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave14_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave15_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave16_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave17_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave18_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave19_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave20_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave21_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave22_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave23_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave24_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave25_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.hhresp.US_Wave26_hhresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave1_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave2_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave3_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave4_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave5_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave6_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave7_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave8_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave9_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave10_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave11_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave12_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave13_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave14_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave15_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave16_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave17_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave18_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave19_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave20_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave21_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave22_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave23_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave24_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave25_indresp_Record;
import uk.ac.leeds.ccg.data.us.data.indresp.US_Wave26_indresp_Record;
...
public class US_Main_Process extends US_Object {
    ...
    public static void main(String[] args) {
        try {
            ...
            US_Environment env = new US_Environment(de);
            US_Main_Process p = new US_Main_Process(env);
            // Main switches
    ...
    public void run() throws IOException {
       ...
       Path indir = files.getUSInputDir();
       Path generateddir = files.getGeneratedDir();
       Path outdir = files.getGeneratedUSSubsetsDir();
 ...
 collections will be merged one by one in doDataProcessingStep2.
     ...
     */
    public void doDataProcessingStep1(Path indir, Path outdir, int n,
            HashMap<Short, String> WaveBHPSNameLookup,
            HashMap<Short, String> WaveUKHLSNameLookup) throws IOException {
         ...
         */
        HashMap<Short, HashSet<US_ID>> sets = new HashMap<>();
        name = "indresp";
        System.out.println(name);
        type = "bhps";
        for (short wave = 1; wave < WaveBHPSNameLookup.size() + 1; wave++) {
            HashSet<US_ID> set0 = sets.get((short) (wave - 1));
            HashSet<US_ID> set1 = new HashSet<>();
            sets.put(wave, set1);
            HashMap<Integer, Short> HIDPToHSOWN;
            HIDPToHSOWN = HIDPToHSOWNLookups.get(wave);
            indir2 = Paths.get(indir.toString(), type + "_w" + wave);
            swave = WaveBHPSNameLookup.get(wave);
            f = US_Data.getInputFile(name, swave, indir2);
            outf = Paths.get(outdir.toString(), swave + "_Wave" + wave + "_" + type + "Subset.csv");
            PrintWriter pw0;
            pw0 = Generic_IO.getPrintWriter(outf, false);
            printHeader(wave, pw0);
            outf = Paths.get(outdir.toString(), swave + "_Wave" + wave + "_" + type + ".csv");
            PrintWriter pw1;
