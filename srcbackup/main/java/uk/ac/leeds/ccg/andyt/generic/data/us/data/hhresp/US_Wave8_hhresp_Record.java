...
public class US_Wave8_hhresp_Record extends US_hhresp_Record {
...
protected final void initHSIVW7(String s) {
if (!s.trim().isEmpty()) {
HSIVW7 = Byte.parseByte(s);
} else {
HSIVW7 = Byte.MIN_VALUE;
}
}
...
public US_Wave8_hhresp_Record(String line) {
s = line.split("\t");
initHID(s[0]);
initHIDP(s[1]);
initINTDATED(s[2]);
